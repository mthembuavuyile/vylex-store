      ...
      <header className={`header ${scrolled ? 'scrolled' : ''}`}>
        <div className="container header-inner">
          <Link href="/" className="logo logo-light" onClick={() => setCheckoutStep('browse')}>
            <img src="/logo.png" alt="Vybetek Logo" width="36" height="36" style={{ flexShrink: 0, objectFit: 'contain' }} />
              ...
              <div>
                ...
                <ul className="drawer-nav-list">
                  ...
                  <li>
                    ...
                    >
                      <span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <Info size={16} style={{ color: 'var(--orange)' }} /> About Vybetek
                      </span>
                      <ChevronRight size={14} />
                    </Link>
                  </li>
          ...
          <div className="footer-grid">
            <div className="footer-col">
              <a href="#" className="logo logo-light" style={{ marginBottom: '16px' }}>
                <img src="/logo.png" alt="Vybetek Logo" width="32" height="32" style={{ flexShrink: 0, objectFit: 'contain' }} />
                <span className="logo-text">vybetek</span>
              </a>
            ...
            <div className="footer-col">
              <h3>Customer Care</h3>
              <ul className="footer-links">
                <li><Link href="/shipping" style={{ color: 'inherit', textDecoration: 'none' }}>Shipping & Deliveries</Link></li>
                <li><Link href="/refund" style={{ color: 'inherit', textDecoration: 'none' }}>Refund Policy</Link></li>
                <li><Link href="/terms" style={{ color: 'inherit', textDecoration: 'none' }}>Terms & Conditions</Link></li>
                <li><Link href="/about" style={{ color: 'inherit', textDecoration: 'none' }}>About Vybetek</Link></li>
                <li><Link href="/admin" style={{ color: 'var(--orange)', fontWeight: 600, textDecoration: 'none' }}>Admin Portal</Link></li>
              </ul>
            </div>
          </div>
